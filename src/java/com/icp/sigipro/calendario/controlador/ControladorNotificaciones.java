 ...
 * @author Amed
 */
@WebServlet(name = "ControladorNotificaciones", urlPatterns = {"/Calendario/Notificaciones"})
public class ControladorNotificaciones extends SIGIPROServlet {
  ...
  protected final Class clase = ControladorNotificaciones.class;
  ...
  protected void getAgregar(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    String redireccion = "Notificaciones/Agregar.jsp";
...
// <editor-fold defaultstate="collapsed" desc="Métodos Post">
  protected void postAgregar(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
   ...
   //index
    ...
    if (resultado) {
        redireccion= "Notificaciones?&tipo=exito&mensaje=" + "Evento agregado correctamente";
        request.setAttribute("mensaje", helper.mensajeDeExito("Evento agregado con éxito"));
    } else {
      redireccion= "Notificaciones?&tipo=error&mensaje=" + "Hubo un error al agregar el evento";
 ...
 protected void postEliminar(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
   ...
   //index
    ...
    try {
      ...
      //*----------------------------*
      redireccion= "Notificaciones?&tipo=exito&mensaje=" + "Evento eliminado correctamente";
    } catch (SIGIPROException ex) {
      redireccion= "Notificaciones?&tipo=error&mensaje=" + "Hubo un error al eliminar el evento";
    }
    response.sendRedirect(redireccion);
    //redireccionar(request, response, redireccion);
  }

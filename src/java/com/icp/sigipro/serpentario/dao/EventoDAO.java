...
public class EventoDAO extends DAO {
    ...
    public boolean eliminarEvento(int id_evento) throws SIGIPROException {
        boolean resultado = false;
        try {
            ...
            ex.printStackTrace();
            throw new SIGIPROException("Evento no pudo ser eliminado debido a que una o más objetos se encuentran asociadas a esta.");
        }
        return resultado;
    }

...
public class CajaDAO {
  ...
  public boolean insertarCaja(Caja p) throws SIGIPROException {
    ...
    try {
      PreparedStatement consulta = getConexion().prepareStatement(" INSERT INTO bioterio.cajas (numero)"  
  ...
  public Caja obtenerCaja(int id) throws SIGIPROException {
    ...
    try {
      PreparedStatement consulta = getConexion().prepareStatement("SELECT * FROM bioterio.cajas  where id_caja = ?");
  ...
  public List<Caja> obtenerCajas() throws SIGIPROException {

    List<Caja> resultado = new ArrayList<Caja>();

    try {
      PreparedStatement consulta;
      consulta = getConexion().prepareStatement(" SELECT * FROM bioterio.cajas");
      ResultSet rs = consulta.executeQuery();

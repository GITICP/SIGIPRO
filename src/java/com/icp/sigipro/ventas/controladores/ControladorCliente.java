...
public class ControladorCliente extends SIGIPROServlet {
  ...
  protected final List<String> categoriasEstado = new ArrayList<String>() {
    {
      add("A");
      add("B");
      add("C");
  ...
  protected void getAgregar(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    ...
    request.setAttribute("estados", categoriasEstado);
  ...
  protected void postEditar(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException, ParseException, SIGIPROException {
    ...
    if (resultado) {
      ...
      Cliente ds = dao.obtenerCliente(Integer.parseInt(request.getParameter("id_cliente")));
      List<String> countries = new ArrayList<String>();
      Locale[] locales = Locale.getAvailableLocales();
      for (Locale locale : locales) {
        String name = locale.getDisplayCountry();

 ...
 * @author Josue
 */
@WebServlet(name = "ControladorObtenerProductosIntencionDeVentaAjax", urlPatterns = {"/productos_intencion_venta"})
public class ControladorObtenerProductosIntencionDeVentaAjax extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ControladorObtenerProductosIntencionDeVentaAjax</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ControladorObtenerProductosIntencionDeVentaAjax at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        Producto_IntencionDAO nDAO = new Producto_IntencionDAO();
        boolean hayNotificaciones = false;
        String id = request.getParameter("id");
        int id_intencion = Integer.parseInt(id);
        try {

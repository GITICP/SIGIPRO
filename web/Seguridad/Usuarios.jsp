                    ...
                    <div class="widget widget-table">
                        <div class="widget-header">
                            ...
                            <div class="btn-group widget-header-toolbar">
                                <button class="btn btn-danger btn-sm" data-toggle="modal" data-target="#modalDesactivarUsuario" style="margin-left:5px;margin-right:5px;" type="submit">Desactivar</button>                                    

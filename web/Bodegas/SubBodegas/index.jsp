                ...
                <div class="main-content">
                    ...
                    <div class="widget widget-table">
                        <div class="widget-header">
                            <h3><i class="fa fa-th-large"></i> Sub bodegas </h3>

                            <c:set var="contienePermiso" value="false" />
                            <c:forEach var="permiso" items="${sessionScope.listaPermisos}">
                                <c:if test="${permiso == 1 || permiso == 70}">
                                ...
                                <tbody>
                                    <c:forEach items="${listaSubBodegas}" var="subBodega">
                                        ...
                                        <tr id="${subBodega.getId_sub_bodega()}">
                                            <td>
                                                <a href="/SIGIPRO/Bodegas/SubBodegas?accion=ver&id_sub_bodega=${subBodega.getId_sub_bodega()}">
                                                    <div style="height:100%;width:100%">${subBodega.getNombre()}</div>
                                                </a>
                                            </td>
                                            <td>${subBodega.getSeccion().getNombre_seccion()}</td>
                                            <td>${subBodega.getUsuario().getNombreCompleto()}</td>
                                        </tr>

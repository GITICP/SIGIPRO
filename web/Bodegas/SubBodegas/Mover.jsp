      ...
      <div class="row">
        <div class="col-md-12 ">
          <ul class="breadcrumb">
            ...
            <li class="active"> Registrar Movimiento de Producto de Sub Bodega a Otra</li>
          </ul>
        </div>
      </div>
        ...
        <div class="main-content">
          ...
          <div class="widget widget-table">
            <div class="widget-header">
              <h3><i class="fa fa-th-large"></i> Registrar Movimiento de Producto de Sub Bodega </h3>
            </div>
            ${mensaje}
            <div class="widget-content">

              <jsp:include page="FormularioMovimiento.jsp"></jsp:include>

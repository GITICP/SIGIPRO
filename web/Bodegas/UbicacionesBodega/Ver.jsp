            ...
            <div class="widget-header">
              ...
              <div class="btn-group widget-header-toolbar">
                ...
                <c:if test="${contienePermisoEliminar}">
                  <a class="btn btn-danger btn-sm boton-accion confirmable" data-texto-confirmacion="la ubicación" data-href="/SIGIPRO/Bodegas/UbicacionesBodega?accion=eliminar&id_ubicacion=${ubicacion.getId_ubicacion()}">Eliminar</a>
                </c:if>

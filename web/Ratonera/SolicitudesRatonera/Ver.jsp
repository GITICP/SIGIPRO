        ...
        <div class="main-content">
          ...
          <div class="widget widget-table">
            <div class="widget-header">
              <h3><i class="fa fa-barcode"></i> Solicitud Número ${solicitud.getId_solicitud()} </h3>
              <div class="btn-group widget-header-toolbar">
                <c:if test="${solicitud.getEstado() == 'Pendiente'}">
                  <a class="btn btn-warning btn-sm boton-accion" href="/SIGIPRO/Ratonera/SolicitudesRatonera?accion=editar&id_solicitud=${solicitud.getId_solicitud()}">Editar</a>
                  <a class="btn btn-danger btn-sm boton-accion confirmable" data-texto-confirmacion="eliminar la Solicitud" data-href="/SIGIPRO/Ratonera/SolicitudesRatonera?accion=eliminar&id_solicitud=${solicitud.getId_solicitud()}">Eliminar</a>
                </c:if>
              </div>
            </div>
            ${mensaje}
            <div class="widget-content">
              <table class="tabla-ver">
                ...
                <tr><td> <strong>Cepa:</strong> <td>  ${solicitud.getCepa().getNombre()}</td></tr>

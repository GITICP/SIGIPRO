            ...
            <div class="row">
                <div class="col-md-12 ">
                    <ul class="breadcrumb">
                        ...
                        <li><a href="/SIGIPRO/Produccion/Paso?accion=ver&id_paso=${paso.getId_paso()}">Historial de ${paso.getNombre()}</a> </li>
                        <li class="active">Versión ${paso.getVersion()}</li>
                    </ul>
                </div>
            </div>
            <!-- main -->
                        ...
                        <div class="widget-header">
                            ...
                            <div class="btn-group widget-header-toolbar">
                                <c:if test="${helper_permisos.validarPermiso(sessionScope.listaPermisos, 650)}">
                                    <a class="btn btn-warning btn-sm boton-accion" href="/SIGIPRO/Produccion/Paso?accion=activar&id_historial=${paso.getId_historial()}&id_paso=${paso.getId_paso()}">Activar</a>
                                </c:if>
                            </div>
                        </div>
                        ${mensaje}

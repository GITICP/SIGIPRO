...
<form class="form-horizontal" id="agregarPaso" autocomplete="off" enctype='multipart/form-data' method="post" action="Paso">
    <div class="row">
        <div class="col-md-12">
            ...
            <input hidden="true" id='listaActividades' name='listaActividades' value='${listaActividades}'>
                    ...
                    <div class="campos sortable" id="sortable">
                        <c:forEach items="${lista}" var="i">
                            <c:choose>
                                ...
                                <c:when test="${diccionario.get(i).get('tipocampo').equals('usuario')}">
                                ...
                                <c:when test="${diccionario.get(i).get('tipocampo').equals('aa')}">
                                    <div class="widget widget-table aa_${i}" id="${i}">
                                        <input hidden="true" id="elemento_${i}" value="aa">
                                        <input hidden="true" id="nombreactividad_${i}" name="aa_nombreactividad_${i}" value="${diccionario.get(i).get('nombreactividad')}">
                                        <div class="widget-header">
                                            <h3><i class="fa fa-edit"></i> Referencia a Actividad de Apoyo #${i}</h3>
                                            <div class="btn-group widget-header-toolbar">
                                                <button type="button" id="boton_eliminar" class="btn btn-danger btn-sm eliminar" onclick="eliminarCampo('aa_${i}')" style="margin-left:7px;margin-right:5px;">Eliminar</button>
                                            </div>
                                        </div>
                                        <div class="widget-content">
                                            <div class="col-md-12">
                                                <label for="tipo" class="control-label"> *Actividad de Apoyo</label>
                                                <div class="form-group">
                                                    <div class="col-sm-12">
                                                        <div class="input-group">
                                                            <select id="actividad_${i}" class="select2" name="aa_actividad_${i}" onchange="actualizarNombre_actividad('${i}')"  
                                                                    style='background-color: #fff;' required
                                                                    oninvalid="setCustomValidity('Este campo es requerido')"
                                                                    onchange="setCustomValidity('')">
                                                                <option value=''></option>
                                                                <c:forEach items="${actividades}" var="actividad">
                                                                    <c:choose>
                                                                        <c:when test="${actividad.getId_actividad() == diccionario.get(i).get('actividad')}" >
                                                                            <option value=${actividad.getId_actividad()} selected> ${actividad.getNombre()}</option>
                                                                        </c:when>
                                                                        <c:otherwise>
                                                                            <option value=${actividad.getId_actividad()}> ${actividad.getNombre()}</option>
                                                                        </c:otherwise>
                                                                    </c:choose>
                                                                </c:forEach>
                                                            </select>
                    ...
                    <div class="form-group">
                        <div class="col-sm-12">
                            <div class="input-group">
                                ...
                                <button type="button" onclick="agregarActividadApoyo()" class="btn btn-primary"><i class="fa fa-plus-circle"></i> Agregar Actividad de Apoyo </button>
                            </div>
                        </div>
                    </div>
                </div>

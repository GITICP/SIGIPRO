                ...
                <div class="main-content">
                    ...
                    <div class="widget widget-table">
                        <div class="widget-header">
                            <h3><i class="fa fa-gears"></i> Completar Paso ${lote.getPosicion_actual()} - ${lote.getPaso_actual().getNombre()} de Protocolo de Producción ${respuesta.getLote().getProtocolo().getNombre()} </h3>
                        </div>
                        ${mensaje}

...
<t:plantilla_general title="Reservaciones" direccion_contexto="/SIGIPRO">
      ...
      <div class="row">
        <div class="col-md-4 ">
          <ul class="breadcrumb">
            <li>Producción</li>
            <li> 
              <a href="/SIGIPRO/Produccion/Inventario_PT?">Reservaciones</a>
            </li>
        ...
        <div class="main-content">
          ...
          <div class="widget widget-table">
            <div class="widget-header">
              <h3><i class="fa fa-list-alt"></i> Editar Reservación </h3>
            </div>
            ${mensaje}
            <div class="widget-content">

              <jsp:include page="Formulario_reservacion.jsp"></jsp:include>

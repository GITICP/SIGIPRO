...
<t:plantilla_general title="Salidas" direccion_contexto="/SIGIPRO">
      ...
      <div class="row">
        <div class="col-md-4 ">
          <ul class="breadcrumb">
            <li>Producción</li>
            <li> 
              <a href="/SIGIPRO/Produccion/Inventario_PT?">Salidas Extraordinarias</a>
            </li>
        ...
        <div class="main-content">
          ...
          <div class="widget widget-table">
            <div class="widget-header">
              <h3><i class="fa fa-list-alt"></i> Editar  Salida </h3>
            </div>
            ${mensaje}

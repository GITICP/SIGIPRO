            ...
            <div class="row">
                <div class="col-md-12 ">
                    <ul class="breadcrumb">
                        ...
                        <li> Repetir Actividad de Apoyo </li>
                        <li class="active"> ${respuesta.getActividad().getCategoria().getNombre()} - ${respuesta.getActividad().getNombre()} </li>
                ...
                <div class="main-content">
                    ...
                    <div class="widget widget-table">
                        <div class="widget-header">
                            <h3><i class="fa fa-gears"></i> Repetir Actividad de Apoyo ${respuesta.getActividad().getCategoria().getNombre()} - ${respuesta.getActividad().getNombre()} </h3>
                        </div>
                        ${mensaje}
                                ...
                                <div class="form-group">
                                    <div class="modal-footer">
                                        ...
                                        <c:choose>
                                            ...
                                            <c:otherwise>
                                                <button type="submit" class="btn btn-primary"><i class="fa fa-check-circle"></i> Repetir Actividad de Apoyo</button>
                                            </c:otherwise>
                                        </c:choose>    
                                    </div>
                                </div>

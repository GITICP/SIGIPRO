...
EditableGrid.prototype.rowRemoved = function(oldRowIndex, rowId) {
    alert("Removed row '" + oldRowIndex + "' - ID = " + rowId);
};
	...
	with (this) {
		...
		// we must render a whole new table
			...
			var columnCount = getColumnCount();
                        var c = 0;
                        /*if (upperCols !== null && upperCols > 0){
                            for (var e = 0; e < upperCols; e++) {
				var headerCell = document.createElement("TH");
				var td = trHeader.appendChild(headerCell);
				columns[e].headerRenderer._render(-1, e, td, columns[e].label);
                            }
                            c = upperCols;
                            trHeader = tHead.insertRow(1);
                        }*/
			for (c; c < columnCount; c++) {
				var headerCell = document.createElement("TH");
				var td = trHeader.appendChild(headerCell);

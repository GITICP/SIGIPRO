...
// Comentado porque no hace nada. var contadorEditar = 0; //Cuando se edita la cotización, se ejecuta la función siguiente 1 vez, lo cual afecta la selección de la orden de compra
$(function () { /* DOM ready */ //
  ...
  $("#id_cliente").change(function () {
    ...
    var id_orden = select_orden[select_orden.selectedIndex].value;
...
function ajax_productos(id_orden) {
  ...
  try {
    ...
    alert("Algo salió mal con la llamada Ajax");
  }
}

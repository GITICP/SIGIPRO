                    ...
                    <div class="widget widget-table">
                        ...
                        <div class="widget-content">
                            <table class="tabla-ver">
                                ...
                                <tr><td> <strong>Machote de Curva: </strong> 
                                    <td>
                                        <c:choose>
                                            <c:when test="${tiporeactivo.getMachote() == ''}">
                                                Sin machote de curva.
                                            </c:when>
                                            <c:otherwise>
                                                <a href="/SIGIPRO/ControlCalidad/TipoReactivo?accion=archivo&id_tipo_reactivo=${tiporeactivo.getId_tipo_reactivo()}">Descargar Machote</a>
                                            </c:otherwise>
                                        </c:choose>
                                    </td>
                                </tr>

...
<form id="formLista" class="form-horizontal" autocomplete="off" method="post" action="ListaEspera">
  <div class="row">
    ...
    <div class="col-md-6">
      ...
      <div class="form-group">
        <div class="col-sm-12">
          <div class="input-group">
            <c:choose>
              <c:when test="${accion == 'Editar'}">
                <input  hidden="true" type="text" pattern="\d{1,2}/\d{1,2}/\d{4}" id="fecha_solicitud" value="${lista.getFecha_solicitud_S()}"  name="fecha_solicitud" data-date-format="dd/mm/yyyy" > 
              </c:when>
              <c:otherwise>
                <c:choose>
      ...
      <label for="descripcion" class="control-label"> Descripcion de pedido</label>
      <!-- Descripcion -->
      <div class="form-group">
        <div class="col-sm-12">
          <div class="input-group">

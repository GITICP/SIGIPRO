      ...
      <div class="row">
        <div class="col-md-12 ">
          <ul class="breadcrumb">
            ...
            <li class="active"> Agregar Seguimiento de Venta </li>
        ...
        <div class="main-content">
          ...
          <div class="widget widget-table">
            <div class="widget-header">
              <h3><i class="fa fa-list-alt"></i> Agregar Nuevo Seguimiento de Venta </h3>
            </div>
            ${mensaje}
      ...
      <jsp:attribute name="form">
        <form class="form-horizontal" id="formAgregarProducto">
          ...
          <div class="form-group">
            <div class="col-sm-12">
              <div class="input-group">
                  <input id="agregarObservaciones" type="text" required maxlength="499" class="form-control" name="editarObservaciones" value=""
      ...
      <jsp:attribute name="form">
        <form class="form-horizontal" id="formEditarProducto">
          ...
          <div class="form-group">
            <div class="col-sm-12">
              <div class="input-group">
                  <input id="editarObservaciones" type="text" required maxlength="499" class="form-control" name="editarObservaciones" value=""
                    oninvalid="setCustomValidity('Debe ingresar un valor válido. ')"
                    oninput="setCustomValidity('')"> 

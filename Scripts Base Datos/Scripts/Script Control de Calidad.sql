...
CREATE TRIGGER actualizacion_repeticion BEFORE INSERT OR UPDATE ON control_calidad.resultados FOR EACH ROW EXECUTE PROCEDURE control_calidad.consecutivo_repeticiones_resultados();

...
INSERT INTO seguridad.entradas_menu_principal(id_menu_principal, id_padre, tag, redirect) VALUES (307, 300, 'ColecciónHúmeda', '/Serpentario/ColeccionHumeda');
INSERT INTO seguridad.entradas_menu_principal(id_menu_principal, id_padre, tag, redirect) VALUES (308, 300, 'CatálogoTejido', '/Serpentario/CatalogoTejido');

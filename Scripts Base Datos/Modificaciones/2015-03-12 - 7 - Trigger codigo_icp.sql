...
CREATE TRIGGER tggr_cod_icp_insert BEFORE INSERT ON bodega.catalogo_interno FOR EACH ROW EXECUTE PROCEDURE cod_icp_consecutivo();
CREATE TRIGGER tggr_cod_icp_update BEFORE UPDATE ON bodega.catalogo_interno FOR EACH ROW EXECUTE PROCEDURE cod_icp_consecutivo();